...
const styles = StyleSheet.create({
  ...
  marqueMini: { flex: 1, textAlign: 'center', color: couleurs.dore, fontFamily: polices.displaySemiGras, letterSpacing: 3, fontSize: 16 },
  ...
  libelleEtapeActif: { color: couleurs.accentClair },
  ...
  titreEtape: { flex: 1, color: couleurs.doreClair, fontFamily: polices.displaySemiGras, fontSize: 25 },
  ...
  carteChoixLarge: { borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte, overflow: 'hidden', borderRadius: rayon.sm },
  carteChoixActive: { borderColor: couleurs.accent },
  miniatureCarteLarge: { width: '100%', height: 170 },
  texteCarteLarge: { padding: espacement.md },
  titreCarteLarge: { color: couleurs.doreClair, fontFamily: polices.titre, fontSize: 22 },
  ...
  tag: { ...stylePetitesCapitales, color: couleurs.texteAtténué, fontSize: 9, borderWidth: 1, borderColor: couleurs.bordureSubtile, paddingHorizontal: 7, paddingVertical: 3 },
  portrait: { width: '100%', aspectRatio: 3 / 4, borderWidth: 1, borderColor: couleurs.bordureDoree, borderRadius: rayon.sm, backgroundColor: couleurs.fondCarteDense },
  portraitVide: { alignItems: 'center', justifyContent: 'center' },
  runePortrait: { color: couleurs.dore, fontSize: 42 },
  cartouchePortrait: { marginTop: espacement.sm, padding: espacement.md, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte },
  ...
  puceOption: { minHeight: 42, minWidth: 92, flexGrow: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: espacement.sm, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondChampSaisie },
  puceOptionActive: { borderColor: couleurs.accent, backgroundColor: 'rgba(78, 174, 248, 0.12)' },
  puceOptionBloquee: { opacity: 0.32 },
  textePuceOption: { color: couleurs.texteAtténué, fontFamily: polices.corpsMedium, fontSize: 13 },
  textePuceOptionActif: { color: couleurs.accentClair },
  presse: { opacity: 0.75 },
  racesHorizontales: { gap: espacement.sm, paddingBottom: 2 },
  carteRace: { width: 126, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte, overflow: 'hidden' },
  carteRaceActive: { borderColor: couleurs.accent, backgroundColor: 'rgba(78,174,248,0.08)' },
  imageRace: { width: '100%', height: 108 },
  imageRaceVide: { width: '100%', height: 108, backgroundColor: couleurs.fondCarteDense },
  nomRace: { color: couleurs.texte, fontFamily: polices.corpsMedium, fontSize: 14, paddingHorizontal: 8, paddingTop: 7 },
  sousTitreRace: { color: couleurs.texteAtténué, fontFamily: polices.corps, fontSize: 11, paddingHorizontal: 8, paddingBottom: 7 },
  ...
  banniereDepart: { width: '100%', height: 230, borderWidth: 1, borderColor: couleurs.bordureDoree, marginBottom: espacement.sm },
  lieuxHorizontaux: { gap: espacement.sm, paddingBottom: 2 },
  carteLieu: { width: 180, minHeight: 130, padding: espacement.md, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte },
  carteLieuActive: { borderColor: couleurs.dore, backgroundColor: 'rgba(216,179,107,0.08)' },
  symboleLieu: { color: couleurs.dore, fontSize: 22, marginBottom: espacement.sm },
  nomLieu: { color: couleurs.texte, fontFamily: polices.titre, fontSize: 17 },
  descriptionLieu: { color: couleurs.texteAtténué, fontFamily: polices.corps, fontSize: 12, lineHeight: 16, marginTop: 3 },
  grilleSituations: { flexDirection: 'row', flexWrap: 'wrap', gap: espacement.sm },
  carteSituation: { minWidth: 220, flexGrow: 1, flexBasis: '31%', padding: espacement.md, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte },
  carteSituationActive: { borderColor: couleurs.accent, backgroundColor: 'rgba(78,174,248,0.08)' },
  titreSituation: { color: couleurs.doreClair, fontFamily: polices.titre, fontSize: 17 },
  descriptionSituation: { color: couleurs.texteAtténué, fontFamily: polices.corps, fontSize: 13, lineHeight: 18, marginTop: 3 },
  blocScenario: { marginTop: espacement.lg, padding: espacement.md, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte },
  ...
  ligneAvancee: { marginTop: espacement.lg, minHeight: 70, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: espacement.md, padding: espacement.md, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarte },
  titreAvance: { color: couleurs.dore, fontFamily: polices.titre, fontSize: 18 },
  chevronAvance: { color: couleurs.dore, fontSize: 20 },
  blocAvance: { padding: espacement.md, borderLeftWidth: 1, borderRightWidth: 1, borderBottomWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: 'rgba(4, 12, 22, 0.72)' },
  portraitRecap: { width: '100%', aspectRatio: 3 / 4, borderWidth: 1, borderColor: couleurs.bordureDoree },
  ficheRecap: { flex: 1.28, padding: espacement.lg, borderWidth: 1, borderColor: couleurs.bordureSubtile, backgroundColor: couleurs.fondCarteDense },
  recapNom: { color: couleurs.doreClair, fontFamily: polices.displaySemiGras, fontSize: 30 },
  ...
  titreModal: { color: couleurs.doreClair, fontFamily: polices.displaySemiGras, fontSize: 24, marginBottom: espacement.md },
  personaLigne: { paddingVertical: espacement.md, borderBottomWidth: 1, borderBottomColor: couleurs.bordureSubtile },
  personaNom: { color: couleurs.dore, fontFamily: polices.titre, fontSize: 19 },
